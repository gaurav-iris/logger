 ...
 *
 */
Configure::write('Routing.prefixes', array('su'));
 ...
 */
	...
	Configure::write('Session', array(
	    'defaults' => 'php',
	    'cookie' => 'ls',
	    'timeout' => 99999//3 days
	));

/**
 * A random string used in security hashing methods.
 */
	Configure::write('Security.salt', 'DYhG93b0qyJdJdlohDtpsjKlsgvR2G0FgaC9mi');

/**
 * A random numeric string (digits only) used to encrypt/decrypt strings.
 */
	Configure::write('Security.cipherSeed', '7685930966756876546789749683645');
