;(function ($, window, document, undefined ) {
    ...
    function uploadFile(file){
        var li = document.createElement("li"),div = document.createElement("div"),img,progressBarContainer = document.createElement("div"),			
                progressBar = document.createElement("div"),reader,xhr,fileInfo;
		var wrap=$('<div class="wfiles">');
                var itm =$('<div class="fitm">');
                var img = $('<img />');
                var bar = $('<div aria-valuemax="100" aria-valuemin="0" role="progressbar" class="progress-bar progress-bar-success"></div>');
		var pBar = $('<div class="progress progress-striped active"></div>').append(bar);
